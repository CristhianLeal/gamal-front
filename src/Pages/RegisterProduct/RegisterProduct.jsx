  ...
  const onSubmit = async (data) => {
    if (name === null) {
      try {
        ...
        const response = await axios.post('https://gamaldigital.com:8080/products', data, { headers })
      ...
      try {
        ...
        const response = await axios.put(`https://gamaldigital.com:8080/products/${id}`, data, { headers })
        if (response.status === 201) {
          toast.success(response.data.message)
          clearStorage()
